...
class CornerstoneSessionHandler implements SessionHandlerInterface {
  ...
  */
  public function read($sessionID) {
    ...
    $result = $this->conn->dbh->selecting(DB_PREFIX . "session", "session_data", where(eq('session_id', $sessionID)));
  ...
  */
  public function write($sessionID, $data) {
    ...
    // Replace the data
    $this->conn->dbh->query_prepared("REPLACE INTO " . DB_PREFIX . "session(session_id, session_ip_address, session_user_id, session_data , session_access_dtm) VALUES (?, ?, ?, ?, ?)", [$sessionID, $_SERVER['REMOTE_ADDR'], $userID, $data, $access_dtm->format('Y-m-d H:i:s')]);
  ...
  */
  public function destroy($sessionID) {
    ...
    $this->conn->dbh->delete(DB_PREFIX . "session", where(eq('session_id', $sessionID)));
  ...
  */
  public function gc($lifetime) {
    ...
    // Get the session from the database
    $this->conn->dbh->delete(DB_PREFIX . "session", where(lt('session_access_dtm', $expiredTime->format('Y-m-d H:i:s'))));
