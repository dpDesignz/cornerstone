...
/**
 * The "Timezone" related functions file
 *
 * @package Cornerstone
 * @author Cal Henderson <cal@iamcal.com>
 * @link https://github.com/iamcal/lib_timezones
 *
 * @since 0.7.0 Introduced.
 * @modifiedDate 06/08/2022 (d/m/y)
 */
 ...
 *
 * FIELDS:
 *  [DISPLAY-LABEL, TZ-ID, DEFAULT-FOR-OFFSET, BASIC-LABEL, DST-LABEL]
 *
 * @return array Will return an array of timezone data.
 */
function timezones_list()
{
  ...
  return array(
    ...
    array('(UTC-05:00) Bogota, Lima, Quito', 'America/Bogota', false, 'South America Pacific Standard Time', NULL),
    ...
    array('(UTC-04:00) Georgetown, La Paz, Manaus, San Juan', 'America/Manaus', true, 'Atlantic Standard Time', NULL),
    ...
    array('(UTC-03:00) Cayenne, Fortaleza', 'America/Cayenne', false, 'French Guiana Time', NULL),
    ...
    array('(UTC) Dublin, Edinburgh, Lisbon, London', 'Europe/London', false, 'Greenwich Mean Time', 'British Summer Time'),
    ...
    array('(UTC+02:00) Amman', 'Asia/Amman', false, 'Arabia Standard Time', 'Arabia Standard Time'),
    ...
    array('(UTC+02:00) Kaliningrad', 'Europe/Kaliningrad', false, 'Eastern European Time', NULL),
    ...
    array('(UTC+03:00) Moscow, St. Petersburg, Volgograd', 'Europe/Moscow', true, 'Moscow Time', NULL),
    ...
    array('(UTC+04:00) Astrakhan, Ulyanovsk', 'Europe/Astrakhan', false, 'Samara Standard Time', NULL),
    array('(UTC+04:00) Baku', 'Asia/Baku', true, 'Azerbaijan Time', 'Azerbaijan Summer Time'),
    array('(UTC+04:00) Izhevsk, Samara', 'Europe/Samara', false, 'Samara Time', NULL),
    ...
    array('(UTC+05:00) Ekaterinburg', 'Asia/Yekaterinburg', false, 'Yekaterinburg Time', NULL),
    ...
    array('(UTC+05:30) Sri Jayawardenepura', 'Asia/Colombo', false, 'ISri Lanka Standard Time', NULL),
    ...
    array('(UTC+07:00) Novosibirsk', 'Asia/Novosibirsk', false, 'Novosibirsk Time', NULL),
    ...
    array('(UTC+07:00) Krasnoyarsk', 'Asia/Krasnoyarsk', false, 'Krasnoyarsk Time', NULL),
    ...
    array('(UTC+08:00) Irkutsk', 'Asia/Irkutsk', false, 'Irkutsk Time', NULL),
    array('(UTC+08:00) Kuala Lumpur, Singapore', 'Asia/Kuala_Lumpur', false, 'Singapore Standard Time', NULL),
    ...
    array('(UTC+09:00) Yakutsk', 'Asia/Yakutsk', false, 'Yakutsk Time', NULL),
    ...
    array('(UTC+10:00) Guam, Port Moresby', 'Pacific/Guam', false, 'West Pacific Standard Time', NULL),
    array('(UTC+10:00) Hobart', 'Australia/Hobart', false, 'Australian Eastern Standard Time', 'Australian Eastern Daylight Time'),
    array('(UTC+10:00) Vladivostok', 'Asia/Vladivostok', false, 'Vladivostok Time', NULL),
    ...
    array('(UTC+11:00) Chokirdakh', 'Asia/Srednekolymsk', false, 'Srednekolymsk Time', NULL),
    ...
    array('(UTC+11:00) Solomon Islands, New Caledonia', 'Pacific/Guadalcanal', false, 'Central Pacific Standard Time', NULL),
    array('(UTC+12:00) Anadyr, Petropavlovsk-Kamchatsky', 'Asia/Anadyr', false, 'Kamchatka Time', NULL),
 ...
 *
 * @param string $zone The ID to guess
 * @param string $default `[optional]` The default result to return if no match found
 *
 * @return string Will return an ID if one is found, otherwise will return the default value.
 */
 ...
 *
 * @param string $zone The ID to return for
 * @param string $ts `[optional]` The timestamp to check
 *
 * @return string Will return the label if one is found, otherwise will return an empty string.
 */
