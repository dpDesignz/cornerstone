...
defined('DB_NAME') or define('DB_NAME', 'cornerstone'); // Database Name
defined('DB_USER') or define('DB_USER', 'cornerstone_user'); // Database Username
defined('DB_PASSWORD') or define('DB_PASSWORD', '8GNovdFIMlDTgP43'); // Database Password
