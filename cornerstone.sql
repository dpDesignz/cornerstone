...
ADD
  PRIMARY KEY (`auth_id`),
ADD
  KEY `cs_authorization_ibfk_1` (`auth_user_id`);
--
...
ADD
  KEY `cmeta_content_id` (`cmeta_content_id`),
ADD
  KEY `cmeta_key` (`cmeta_key`);
--
...
ADD
  KEY `option_edited_id` (`option_edited_id`);
--
...
ADD
  UNIQUE KEY `pwdreset_token` (`pwdreset_token`),
ADD
  KEY `pwdreset_user_id` (`pwdreset_user_id`),
ADD
  KEY `pwd_reset_selector` (`pwdreset_selector`);
--
...
ADD
  PRIMARY KEY (`role_id`),
ADD
  KEY `role_edited_id` (`role_edited_id`);
--
...
ADD
  PRIMARY KEY (`rp_id`),
ADD
  UNIQUE KEY `rp_key` (`rp_key`);
--
  -- Indexes for table `cs_role_perms`
  --
ALTER TABLE `cs_role_perms`
ADD
  PRIMARY KEY (`rpl_role_id`, `rpl_rp_id`),
ADD
  KEY `cs_role_perms_ibfk_2` (`rpl_rp_id`),
ADD
  KEY `rpl_role_id` (`rpl_role_id`, `rpl_rp_id`) USING BTREE;
--
...
ADD
  PRIMARY KEY (`seo_id`),
ADD
  UNIQUE KEY `seo_keyword` (`seo_keyword`),
ADD
  KEY `seo_type_id` (`seo_type_id`);
--
...
ADD
  PRIMARY KEY (`user_id`),
ADD
  UNIQUE KEY `user_username` (`user_login`),
ADD
...
ADD
  KEY `umeta_userID` (`umeta_user_id`),
ADD
  KEY `umeta_editedID` (`umeta_edited_id`);
--
...
ALTER TABLE `cs_content_meta`
MODIFY
  `cmeta_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 10;
--
...
ALTER TABLE `cs_password_reset`
MODIFY
  `pwdreset_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 14;
--
...
ALTER TABLE `cs_user_meta`
MODIFY
  `umeta_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 3;
--
...
ALTER TABLE `cs_authorization`
ADD
  CONSTRAINT `cs_authorization_ibfk_1` FOREIGN KEY (`auth_user_id`) REFERENCES `cs_users` (`user_id`) ON DELETE CASCADE;
--
  -- Constraints for table `cs_edit_log`
  --
ALTER TABLE `cs_edit_log`
ADD
  CONSTRAINT `cs_edit_log_ibfk_1` FOREIGN KEY (`edit_user_id`) REFERENCES `cs_users` (`user_id`);
--
  -- Constraints for table `cs_options`
  --
ALTER TABLE `cs_options`
ADD
  CONSTRAINT `cs_options_ibfk_1` FOREIGN KEY (`option_edited_id`) REFERENCES `cs_users` (`user_id`);
--
  -- Constraints for table `cs_roles`
  --
ALTER TABLE `cs_roles`
ADD
  CONSTRAINT `cs_roles_ibfk_1` FOREIGN KEY (`role_edited_id`) REFERENCES `cs_users` (`user_id`);
--
  -- Constraints for table `cs_role_perms`
  --
ALTER TABLE `cs_role_perms`
ADD
  CONSTRAINT `cs_role_perms_ibfk_1` FOREIGN KEY (`rpl_role_id`) REFERENCES `cs_roles` (`role_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `cs_role_perms_ibfk_2` FOREIGN KEY (`rpl_rp_id`) REFERENCES `cs_role_permissions` (`rp_id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
  -- Constraints for table `cs_users`
  --
ALTER TABLE `cs_users`
ADD
  CONSTRAINT `cs_users_ibfk_1` FOREIGN KEY (`user_role_id`) REFERENCES `cs_roles` (`role_id`),
ADD
  CONSTRAINT `cs_users_ibfk_2` FOREIGN KEY (`user_edited_id`) REFERENCES `cs_users` (`user_id`);
--
  -- Constraints for table `cs_user_meta`
  --
ALTER TABLE `cs_user_meta`
ADD
  CONSTRAINT `cs_user_meta_ibfk_1` FOREIGN KEY (`umeta_user_id`) REFERENCES `cs_users` (`user_id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `cs_user_meta_ibfk_2` FOREIGN KEY (`umeta_edited_id`) REFERENCES `cs_users` (`user_id`);
COMMIT;
