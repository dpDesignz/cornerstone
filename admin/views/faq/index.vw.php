...
$pageMetaTitle = "FAQs | " . $data->site_name . " Admin";
$pageMetaDescription = $data->site_name . " faq list.";
$pageMetaImage = get_site_url('img/site_ogp_image.png');
$pageMetaCanonical = get_site_url('admin/faq');
...
<?php if (!empty($data->noData) && $data->noData) { ?>
  <div id="no-index-data" class="csc-row">
    <div class="csc-col csc-col12">
      <h1>Add an FAQ</h1>
      <p id="no-index-data__tag">Add an FAQ to display on your site</p>
      <p id="no-index-data__btn"><a class="csc-btn" href="<?php echo get_site_url('admin/faq/add'); ?>" data-tippy-content="Add a new FAQ"><i class="fas fa-plus csc-bi-left"></i> Add FAQ</a></p>
      <span id="no-index-data__icon"><i class="far fa-question-circle"></i></span>
    </div>
  </div>
<?php } else { ?>
  <div class="csc-row">
    <section class="csc-col csc-col12 csc-col--md6 cs-mb-md-3">
      <h1 class="cs-mb-0">FAQs<?php if (!empty($data->search)) { ?> <small><em>Search for: <?php echo $data->search; ?></em></small><?php } ?></h1>
    ...
    <section class="csc-col csc-col12 csc-col--md6 cs-text-center cs-text-right-md csc-col--ga-middle">
      <p class="cs-mt-0 cs-mt-md-3">
        <a class="csc-btn--small" href="<?php echo get_site_url('admin/faq/add'); ?>" title="Add a new FAQ"><i class="fas fa-plus csc-bi-left"></i> Add</a>
      </p>
    </section>
  </div>
  <?php flashMsg('admin_faq'); ?>
