...
<head>
  ...
  <link href="<?php echo get_site_url('admin-files/css/admin.css?v=' . str_replace(' ', '', trim(get_option('site_version')))); ?>" rel="stylesheet" type="text/css">
    <?php endif; ?>
  <!-- SCRIPTS -->
  <!-- jQuery library -->
...
<body class="cs-page cs-admin cs-components<?php if(!empty($_COOKIE['sbar']) && $_COOKIE['sbar']) {echo ' sidebar__collapsed';} ?>">
  <!--[if lte IE 9]>
